    ...
    <div class="w-full max-w-screen-xl mx-auto px-4 flex justify-between items-center h-full">
        <div class="flex-1">
            <a href="/" class="font-inter font-bold text-[30px] flex items-center gap-2 text-[#2563EB]">
                <img src="{{ asset('build/assets/images/icon.png') }}" alt="Logo" class="w-8 h-8">
                SumAI
            </a>
        </div>
            ...
            @auth
                ...
                <div x-data="{ open: false }" class="relative">
                    <button @click="open = !open" class="focus:outline-none">
                        <img src="{{ Auth::user()->profile_photo_url ?? asset('build/assets/images/profil.png') }}"
                            alt="Profile"
        ...
        <div class="lg:hidden">
            <details class="dropdown dropdown-end">
                ...
                <ul class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                    ...
                    <li><a href="{{ route('riwayat.index') }}">Riwayat</a></li> <!-- ✅ DITAMBAHKAN -->
